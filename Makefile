...
SRC_NAME = 	ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c ft_puts.c \
			...
			ft_cbuff_create.c ft_cbuff_destroy.c ft_cbuff_enqueue.c \
			ft_cbuff_dequeue.c ft_cbuff_dequeue_till_head_no_change.c \
			ft_cbuff_flush.c ft_cbuff_move_forward_read_head.c
