...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_printf_length_0.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: cledant <marvin@42.fr>                     +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/05/04 11:03:06 by cledant           #+#    #+#             */
/*   Updated: 2016/05/04 11:22:01 by cledant          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			ft_printf_length_0(t_flags *flag, va_list list_arg)
{
	int		len;
